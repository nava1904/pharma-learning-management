...
CREATE TABLE "assessment" (
    ...
    "showSubmissionHistory" boolean NOT NULL DEFAULT false,
    "limitQuestions" bigint
);
...
--
-- Class Assignment as table assignment
--
...
--
-- Class AssignmentSubmission as table assignment_submission
--
...
--
-- Class BatchAnnouncement as table batch_announcement
--
...
--
-- Class BatchAttendanceRecord as table batch_attendance_record
--
...
--
-- Class CertificateTemplate as table certificate_template
--
...
CREATE TABLE "course" (
    ...
    "disableSelfEnrollment" boolean NOT NULL DEFAULT false,
    "category" text,
...
--
-- Class LearnerTrainerMessage as table learner_trainer_message
--
...
CREATE TABLE "lesson" (
    ...
    "lessonType" text,
    "minEngagementMinutes" bigint,
    "prerequisiteMode" text,
    "instructorNotes" text,
    "includeInPreview" boolean NOT NULL DEFAULT false
);

--
-- Class LessonBlock as table lesson_block
--
...
--
-- Class LiveClass as table live_class
--
...
--
-- Class ObservationLog as table observation_log
--
...
--
-- Class PracticalChecklistItem as table practical_checklist_item
--
...
--
-- Class StandaloneAssignment as table standalone_assignment
--
...
--
-- Class StandaloneAssignmentRecipient as table standalone_assignment_recipient
--
...
--
-- Foreign relations for "assignment" table
--
...
--
-- Foreign relations for "assignment_submission" table
--
...
--
-- Foreign relations for "batch_announcement" table
--
...
--
-- Foreign relations for "batch_attendance_record" table
--
...
--
-- Foreign relations for "certificate_template" table
--
...
--
-- Foreign relations for "learner_trainer_message" table
--
...
--
-- Foreign relations for "lesson_block" table
--
...
--
-- Foreign relations for "live_class" table
--
...
--
-- Foreign relations for "observation_log" table
--
...
--
-- Foreign relations for "practical_checklist_item" table
--
...
--
-- Foreign relations for "standalone_assignment" table
--
...
--
-- Foreign relations for "standalone_assignment_recipient" table
--
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('pharma_lms', '20260415172306554', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260415172306554', "timestamp" = now();
